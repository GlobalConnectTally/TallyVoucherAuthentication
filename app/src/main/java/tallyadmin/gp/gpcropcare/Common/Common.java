...
public class Common {
    ...
    public static final String URL_AUTHORIZE = "http://gatewayinfosoft.com/api/TransactionAuthentication";

    public static final String URL_SALES = BASE_URL + "SendSalesDetails";

    public static final String URL_SALESTRANS = "http://gatewayinfosoft.com/api/SendSalesAllDetails";
    ...
    public static final String URL_PAYMENTGET = "http://gatewayinfosoft.com/api/SendPaymentMaster";

    public  static final String URL_SENDPAYMENTDETAILS = "http://gatewayinfosoft.com/api/SendPaymentDetails";

    public  static final String URL_DASHBOARDSBADGES = "http://gatewayinfosoft.com/api/AppDashboard";

    public  static final String URL_SMS = "http://smsidea.co.in/SMS/API/SendTallySMS.aspx";

    public  static final String URL_REPORT = "http://gatewayinfosoft.com/api/GetGpcReportDetails";

    public  static final String URL_REPORTNrc = "http://gatewayinfosoft.com/api/GPCropCareSendReport";
