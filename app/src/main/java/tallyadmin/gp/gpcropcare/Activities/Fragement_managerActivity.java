...
//------fragment manager activity------//
public class Fragement_managerActivity extends AppCompatActivity {
    ...
    private void Rejectinvo() {
        ...
        Okbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_AUTHORIZE,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                try
                                {
                                    ...
                                    if (result == 1)
                                    {
                                        Toast.makeText(Fragement_managerActivity.this, "Authorized success full", Toast.LENGTH_SHORT).show();
                                        startActivity(new Intent(Fragement_managerActivity.this, SalesOrderActivity.class));
                                        finish();
                                    }
                                    else
                                        {
                                        Toast.makeText(Fragement_managerActivity.this, "Authorization Failed" + "  " + result, Toast.LENGTH_SHORT).show();
                                        }
                                }
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(Fragement_managerActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }) {
                    @Override
                ...
                VolleySingleton.getInstance(Fragement_managerActivity.this).addToRequestQueue(stringRequest);
    ...
    private void fetchingJSON() {
        final KProgressHUD Hhdprogress = KProgressHUD.create(Fragement_managerActivity.this)
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (dataArray.length() == 0) {
                                AlertDialog.Builder builder = new AlertDialog.Builder(Fragement_managerActivity.this);
    ...
    private void setupRecycler() {
        ...
        recycler.setLayoutManager(new LinearLayoutManager(Fragement_managerActivity.this, LinearLayoutManager.VERTICAL, false));
        salesOrderAdapter = new SalesTransaAdapter(Saleslist, Fragement_managerActivity.this);
