package com.gpicropcare.library;
...
import com.gpicropcare.library.enums.AppUpdaterError;
import com.gpicropcare.library.enums.Display;
import com.gpicropcare.library.enums.Duration;
import com.gpicropcare.library.enums.UpdateFrom;
import com.gpicropcare.library.interfaces.IAppUpdater;
import com.gpicropcare.library.objects.GitHub;
import com.gpicropcare.library.objects.Update;

import static com.gpicropcare.library.UtilsDisplay.showUpdateAvailableDialog;
                    ...
                    switch (display) {
                        case DIALOG:
                           ...
                           // alertDialog.show();
                            break;
                        case SNACKBAR:
                            //snackbar = UtilsDisplay.showUpdateNotAvailableSnackbar(context, UtilsLibrary.getDurationEnumToBoolean(duration));
                            snackbar.show();
                            break;
                        case NOTIFICATION:
                            //UtilsDisplay.showUpdateNotAvailableNotification(context, titleNoUpdate, iconResId);
                            break;
                    }
                }
            }
