...
public class AppUpdaterUtils {
    ...
    public interface UpdateListener {
         ...
         * @see com.gpicropcare.library.objects.Update
     ...
     * @return this
     * @see com.gpicropcare.library.AppUpdaterUtils.AppUpdaterListener
     * @deprecated
     */
     ...
     * @return this
     * @see com.gpicropcare.library.AppUpdaterUtils.UpdateListener
     */
